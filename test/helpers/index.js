...
async function doRewrite({content, contentType, url = "https://example.com/some/path/index.html", dsRules = null}) {
  const RW = new Rewriter(url, "http://localhost:8080/prefix/20201226101010/", null, dsRules);
