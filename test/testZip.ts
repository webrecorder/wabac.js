...
test("load test.zip entries", async (t) => {
  ...
  t.deepEqual(entries, {
    ...
    "indexes/index.cdxj": {
      ...
      compressedSize: 443,
      localEntryOffset: 327,
      filename: "indexes/index.cdxj",
    },
    "warcs/httpbin-resource.warc.gz": {
      deflate: false,
      uncompressedSize: 465,
      compressedSize: 465,
      localEntryOffset: 910,
      filename: "warcs/httpbin-resource.warc.gz",
    },
    "warcs/example-iana.org-chunked.warc": {
      deflate: false,
      uncompressedSize: 8831,
      compressedSize: 8831,
      localEntryOffset: 1463,
      filename: "warcs/example-iana.org-chunked.warc",
    },
    "warcs/example.warc.gz": {
      deflate: false,
      uncompressedSize: 3816,
      compressedSize: 3816,
      localEntryOffset: 10387,
      filename: "warcs/example.warc.gz",
    },
    "warcs/iana.warc.gz": {
      deflate: false,
      uncompressedSize: 786828,
      compressedSize: 786828,
      localEntryOffset: 14282,
      filename: "warcs/iana.warc.gz",
    },
  });
});
