...
(function () {
  ...
  function Storage(wombat, proxying) {
    ...
    Object.defineProperties(this, {
      data: { enumerable: false, value: {} },
      wombat: { enumerable: false, value: wombat },
      proxying: { enumerable: false, value: proxying },
      _deleteItem: {
        enumerable: false,
        value: function (item) {
  ...
  (Storage.prototype.getItem = function getItem(name) {
    ...
    (Storage.prototype.clear = function clear() {
      return (this.data = {}), this.fireEvent(null, null, null), undefined;
    }),
    ...
    (Wombat.prototype.isNativeFunction = function (funToTest) {
      return (
        !!(funToTest && typeof funToTest === "function") &&
        this.wb_funToString.call(funToTest).indexOf("[native code]") >= 0
      );
    }),
          ...
          prop === "href" &&
            ...
            (value[0] === "."
              ...
              : value[0] === "/" &&
                ...
                ((rel = true), (value = WB_wombat_location.origin + value)));
          try {
    ...
    (Wombat.prototype.rewriteUrl_ = function (originalURL, useRel, mod, doc) {
      ...
      return (
        ...
        prefix
          ...
          : this.isHostUrl(url) && !this.startsWith(url, originalLoc.host + "/")
            ? this.getFinalUrl(useRel, mod, this.wb_orig_scheme + url)
            : url
      );
    }),
    ...
    (Wombat.prototype.initProtoPmOrigin = function (win) {
      if (!win.Object.prototype.__WB_pmw) {
        ...
        win.__WB_check_loc = function (loc) {
          return loc instanceof Location || loc instanceof WombatLocation
            ? this.WB_wombat_location
            : {};
        };
      }
    }),
    ...
    (Wombat.prototype.initOpenOverride = function () {
      ...
      var wombat = this,
        open_rewritten = function open(
          ...
          return wombat.initNewWindowWombat(res, rwStrUrl), res;
        };
    ...
    (Wombat.prototype.initStorageOverride = function () {
      ...
      var local,
        session,
        pLocal = "localStorage",
        pSession = "sessionStorage";
      if (((ThrowExceptions.yes = false), this.$wbwindow.Proxy)) {
      ...
      this.$wbwindow.document.readyState === "complete"
        ...
        : this.$wbwindow.addEventListener
          ...
          : this.$wbwindow.attachEvent &&
            this.$wbwindow.document.attachEvent(
              "onreadystatechange",
              notify_top,
            );
    }),
    ...
    (Wombat.prototype.wombatInit = function () {
      if ((this._internalInit(), this.wb_info.presetCookie))
        for (
