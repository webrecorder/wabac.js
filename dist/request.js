...
export class ArchiveRequest {
    ...
    constructor(wbUrlStr, request, { isRoot = false, mod = "", ts = "", proxyOrigin = undefined, localOrigin = undefined, proxyTLD = undefined, localTLD = undefined, defaultReplayMode = false, } = {}) {
        ...
        if (proxyOrigin && localOrigin && !defaultReplayMode) {
            ...
            if (this.request.referrer) {
                this._proxyReferrer = resolveProxyOrigin(proxyOrigin, localOrigin, this.request.referrer);
            }
...
function resolveProxyOrigin(proxyOrigin, localOrigin, urlStr) {
...
export function resolveFullUrlFromReferrer(url, referrer) {
