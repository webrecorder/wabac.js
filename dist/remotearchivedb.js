...
export class OnDemandPayloadArchiveDB extends ArchiveDB {
    ...
    isSameUrl(remoteUrl, cdxUrl, method) {
        if (remoteUrl === cdxUrl) {
            return true;
        }
    ...
    async loadPayload(cdx, opts) {
        ...
        if (remote.origURL) {
            ...
            if (!this.noCache) {
                ...
                if (origResult.digest !== remote.digest &&
                    remote.digest &&
        ...
        if (!this.noCache && !tooBigForCache && remote.reader && digest) {
            remote.reader = new PayloadBufferingReader(this, remote.reader, digest, cdx.url, this.streamMap, hasher || null, cdx.recordDigest, cdx.source);
        }
        if (tooBigForCache) {
...
// ===========================================================================
export class SimpleRemoteArchiveDB extends OnDemandPayloadArchiveDB {
...
//# sourceMappingURL=remotearchivedb.js.map