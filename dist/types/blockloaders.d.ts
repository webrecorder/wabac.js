...
declare class ArrayBufferLoader extends BaseLoader {
    ...
    getRange(offset: any, length: any, streaming?: boolean): Promise<ReadableStream<any> | Uint8Array>;
}
...
declare class IPFSRangeLoader extends BaseLoader {
    ...
    getRange(offset: number, length: number, streaming?: boolean, signal?: AbortSignal | null): Promise<ReadableStream<any> | Uint8Array>;
}
