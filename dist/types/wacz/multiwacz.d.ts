...
import { type PageEntry, type RemoteResourceEntry, type WACZCollConfig } from "../types";
export type IDXLine = {
    waczname: string;
    prefix: string;
    filename: string;
...
export declare class MultiWACZ extends OnDemandPayloadArchiveDB implements WACZLoadSource {
    ...
    loadWACZFiles(json: {
        ...
        totalPages: number;
    }, parent?: WACZLoadSource): Promise<void>;
    addInitialPages(pagesImport: Record<string, any>[]): Promise<void>;
